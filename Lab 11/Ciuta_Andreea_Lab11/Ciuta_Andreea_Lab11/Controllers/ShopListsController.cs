...
namespace Ciuta_Andreea_Lab11.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ShopListsController : ControllerBase
    {
        private readonly Ciuta_Andreea_Lab11Context _context;

        public ShopListsController(Ciuta_Andreea_Lab11Context context)
        {
            _context = context;
        }
